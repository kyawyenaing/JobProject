    ...
    <div class="col-md-12 col-sm-12 col-xs-12">
        ...
        <div class="x_panel">
            ...
            <br />
                ...
                <form action="{{url('') }}/admin/city/{{$city->id}}" class="form-horizontal col-md-6" method="post">
                    {{csrf_field()}}
                    ...
                    <div class="form-group unicode">
                        ...
                        <div class="col-md-8 col-sm-8 col-xs-12">
                            <input type="text" name="name" value="{{$city->name}}" class="form-control col-md-7 col-xs-12">
                    ...
                    <div class="form-group unicode">
                        ...
                        <div class="col-md-8 col-sm-8 col-xs-12">
                            <input type="text" name="name_mm" class="form-control col-md-7 col-xs-12" value="{{$city->name_mm}}">
